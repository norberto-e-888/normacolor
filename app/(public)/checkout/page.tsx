      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 p-4 bg-muted rounded-lg">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-lg font-semibold">Estado de tu orden</h2>
              <p className="text-muted-foreground">
                {allItemsHaveArt
                  ? "¡Todo listo! Puedes proceder al pago"
                  : `Selecciona diseños para ${
                      items.filter((item) => !selectedArts[item.id]).length
                    } productos restantes`}
              </p>
            </div>
            <button
            ...
            >
              {isSubmitting
                ...
                : allItemsHaveArt
                ? "Pagar"
                : "Selecciona diseños para todos los items"}
            </button>
          </div>
        </div>
